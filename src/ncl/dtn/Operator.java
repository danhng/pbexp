 ...
 */
  ...
  class Operator implements Expressible, Comparable<Operator>, Cloneable {
    ...
    public Evaluable toEvaluable() throws PBEXPException {
        throw new PBEXPException(PBEXPException.CLASS_CAST_EXCEPTION, "Operator objects cannot be cast to Evaluable.");
    }
    ...
    static void throwMismatchOperandCount(String operatorName, int require, int actual) {
        throw new PBEXPException(PBEXPException.OPERANDS_COUNT_MISMATCH, "Operator " + operatorName + " requires" + require +" operands. "
